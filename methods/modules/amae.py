...
class AMAE(LightningModule):
    ...
    def __init__(
        ...
        self.train_transform = train_transform[0]
        self.additional_transform = train_transform[1]
    ...
    def training_step(self, batch: Dict, batch_idx: int) -> Tensor:
        ...
        with torch.no_grad():
            ...
            images_augmented = self.additional_transform(images)[0]
        ...
        # input are images with additional augmentations
        features = self.forward_encoder(images_augmented, idx_keep)
        ...
        # target are the actual patches from unaugmented image
